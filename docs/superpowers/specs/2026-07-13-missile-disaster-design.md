...
- **ガイガーカウンター音**: カメラ/視点が放射能汚染域の近くにあるとき、ガイガー音を小さく再生。Alien Mod の `SoundLoaderBehaviour`（距離減衰つき WAV・一時停止対応）を流用し、汚染強度と距離で音量をスケール。
...
- 放射能汚染地域付近ではガイガーカウンターの音が小さく聞こえるように実装。